...
public class LevelProfile
{
    ...
    public Dictionary<Food, List<Doneness>> AllowedDoneness = new();
    ...
    public static readonly LevelProfile Level1 = new LevelProfile {
        AvailableFoods = new List<Food> { Food.Steak, Food.Ketchup },
        AllowedDoneness = new Dictionary<Food, List<Doneness>> { { Food.Steak, new List<Doneness> { Doneness.Rare, Doneness.MediumRare, Doneness.Medium, Doneness.MediumWell, Doneness.WellDone } } }, 
